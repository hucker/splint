...
from splint import SplintException, splint_rc_factory
...
def test_factory():
    ...
    rc5 = splint_rc_factory(param='./rc_files/good.xml', section='package1')
    rc6 = splint_rc_factory(param='./rc_files/good.ini', section='package1')
...
def test_more_exceptions(param, section):
    with pytest.raises(SplintException):
        _ = splint_rc_factory(param, section=section)
