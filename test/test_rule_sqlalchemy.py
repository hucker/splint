...
def test_rule_sql_table_bad_table(engine):
    # Call the function with the expected columns list
    results = list(
        splint.rule_sql_table_col_name_schema(engine, table='', expected_columns=['users'], extra_columns_ok=True))
...
def test_rule_sql_table_bad_column(engine):
    # Call the function with the expected columns list
    results = list(
        splint.rule_sql_table_col_name_schema(engine, table='users', expected_columns=[''], extra_columns_ok=True))
