...
def test_funct_env_default():
    ...
    def func(x, y=2):
        """Test Function"""
        yield splint.SR(status=(x == 1 and y == 2), msg="It works")

    env = {"x": 1}
    sfunc = splint.SplintFunction(func, env=env)
...
def test_func_defaults_used():
    ...
    def func(x=1, y=2, z=3):
        """Test Function"""
        yield splint.SR(status=(x == 1 and y == 2 and z == 3), msg="It works")
...
def test_funct_all_values():
    ...
    def func(x=1, y=2, z=3):
        """From Environment"""
        yield splint.SR(status=(x == 20 and y == 30 and z == 40), msg="It works")
