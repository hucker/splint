...
Splint message may use SplintMarkup to format them.  In most cases the raw text is sufficient, but there
are instances were nicer output is desired or required.

In order to accomplish this, the SplintMarkup class allows a very simple formatting of the messages.  THis
...
class SplintMarkup:
    ...
    Splint messages can have embedded formatting information that indicates to higher level
...
class SplintRenderText(SplintAbstractRender):
    """
